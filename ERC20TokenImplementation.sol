...
contract ERC20TokenImplementation is Context, IERC20, IBRC20 {
  ...
  function _mint(address account) internal {
    ...
    uint256 amount;
    if ((_totalSupply + _limit) <= _max) {
      amount = _limit;
    } else {
      amount = _max - _totalSupply;
    }
  ...
  function _mintable() internal view returns (bool) {
    return _totalSupply < _max;
  }
}
